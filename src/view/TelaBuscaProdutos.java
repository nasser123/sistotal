 ...
 * @author Produção
 */
public class TelaBuscaProdutos extends javax.swing.JDialog {
    Produto produto;
     ...
     */
    public TelaBuscaProdutos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnName("Codigobarras");
        ...
        org.jdesktop.swingbinding.JComboBoxBinding jComboBoxBinding = org.jdesktop.swingbinding.SwingBindings.createJComboBoxBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, produtoList, jComboBox1);
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        this.produto = (Produto)jComboBox1.getSelectedItem();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                TelaBuscaProdutos dialog = new TelaBuscaProdutos(new javax.swing.JFrame(), true);
