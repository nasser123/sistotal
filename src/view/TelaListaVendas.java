...
public class TelaListaVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idtipoSaida.descricao}"));
        columnBinding.setColumnName("Idtipo Saida");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idvenda.idvenda}"));
        columnBinding.setColumnName("Idvenda");
        columnBinding.setColumnClass(Integer.class);
